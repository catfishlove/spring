...
public class Boot09AopApplication {
	...
	//spring boot application 이 실행될때 호출되는 메소드
	...
	//Spring Bean Container 로부터 WritingUtil 객체 DI 받기
	...
	public void test() {
		...
		messenger.sendGreeting("안녕하세요 OO님!");
		String msg = messenger.getMessage();
		System.out.println("Messenger 객체로부터 받은 매새지:"+msg);
	}
}
