...
public class CafeServiceImpl implements CafeService{
	...
	public void getList(Model model, CafeDto dto) {
		...
		model.addAttribute("list", list); //글 목록
		model.addAttribute("startPageNum", startPageNum);//페이지 네비게이션 시작 번호
		model.addAttribute("endPageNum", endPageNum);//페이지 네비게이션 끝 번호
		...
		model.addAttribute("totalRow", totalRow);//전체 글의 수
	}
