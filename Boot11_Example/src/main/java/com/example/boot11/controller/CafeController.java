...
public class CafeController {
	...
	public String commentList(Model model, CafeCommentDto dto ) {
		//CafeCommentDto 에는 pageNum, ref_group이 들어있다(GET 방식 파라미터)
		...
		//templates/cafe/comment_list.html 에서 댓글이 들어있는 여러개의 li를 응답할 예정
	...
	/*
	 *  CafeCommentDto 에는 ref-group, target_id, content 3개의 정보가 들어있다. 
	 *  
	...
	public String list(Model model, CafeDto dto) {
		//pageNum 또는 keyword 가 파라미터로 전달된다면 dto에 들어있다. 
